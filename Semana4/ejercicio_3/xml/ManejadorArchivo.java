...
public class ManejadorArchivo {
	...
	public void crearArchivo() throws ParserConfigurationException, TransformerConfigurationException, FileNotFoundException, TransformerException {
		...
		Result result = new StreamResult(FileOutputStream);    //aqui es para comparar objetos y tenemos que cerrar esto no estaba se coloca lo de arriba o esta pero solo una   mio 
